...
function SwapStyledAccordionSelect(props) {
    const currencyCode = props.currencyCode ?? '';
    const isInputNum = props.isInputNum ?? false;
    const inputNum = props.inputNum ?? 0;
    const swapNum = props.swapNum ?? 0;
                                ...
                                >
                                    ...
                                    <div style={{ marginLeft: 'auto' }}>
                                        <div className="px-12 font-medium" style={{ textAlign: 'right' }}>
                                            <Typography className="text-16 font-medium">{ isInputNum ? inputNum : row.swapVal }</Typography>
...
export default SwapStyledAccordionSelect;
