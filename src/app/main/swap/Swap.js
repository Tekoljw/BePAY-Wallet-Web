      ...
      {!loadingShow && <div className='mt-12'>
        ...
        {walletType === 0 && (
          ...
          >
            ...
            >
              <Typography className="text-16">{t("home_wallet_13")}</Typography>
            ...
            <div className="flex items-center justify-content-center position-re" style={{ marginBottom: "-46px" }}>
            ...
            <Typography
              className="text-16 font-medium my-16 color-76819B"
            ...
            <Box component={motion.div} variants={item}>
              <Button
                ...
                color="secondary"
                variant="contained"
                sx={{ paddingTop: "2px!important", paddingBottom: "2px!important", fontSize: "20px!important", backgroundColor: "#0D9488", color: "#ffffff" }}
                onClick={() => {
                  onSubmit();
                }}
              >
