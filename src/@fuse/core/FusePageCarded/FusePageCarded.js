...
const Root = styled('div')(({ theme, ...props }) => ({
  ...
  '& .FusePageCarded-wrapper': {
    ...
    minWidth: 0,
    height: '100%',
    backgroundColor: isMobileMedia ? theme.palette.background.paper : '#0e1421',
  ...
  '& .FusePageCarded-sidebarWrapper': {
    ...
    position: 'absolute',
    '&.permanent': {
      [theme.breakpoints.up(isMobileMedia ? 'lg' : 'sm')]: {
        position: 'relative',
        marginLeft: 0,
        marginRight: 0,
  ...
  '& .FusePageCarded-sidebar': {
    ...
    borderRight: isMobileMedia ? '1px solid rgba(241,245,249,.12)' : 'none',
  ...
  '& .FusePageCarded-leftSidebar': {
    width: isMobileMedia ? props.leftsidebarwidth : '24.6rem',
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-auto flex-col container z-10 h-full shadow-1 rounded-t-16 relative overflow-hidden">
          <div className="FusePageCarded-wrapper diBanColor">
